  ...
  <div class="vt-modal-content">
    ...
    <div class="vt-modal-body">
      <div id="mainPannel" class="content" style="display: flex; flex-direction: column; width: 100%; flex: 1; min-height: 0; gap: 8px; justify-content: center;">
        <div id="roomInputContainer" style="display: flex; flex-direction: column; gap: 12px; padding: 16px; width: 100%; background: #f8f9fa; border-radius: 12px; box-sizing: border-box;">
          <div style="display: flex; align-items: center; gap: 12px;">
            <span class="ellipsis" id="videoTogetherRoomNameLabel" style="width: 64px; flex-shrink: 0; font-size: 13px; color: #555; font-weight: 500;">房间</span>
            <input id="videoTogetherRoomNameInput" autocomplete="off" placeholder="请输入房间名" style="flex: 1; height: 38px; padding: 0 14px; font-size: 14px; border-radius: 10px; border: 1px solid #e0e0e0; background: #fff; outline: none; transition: border-color 0.2s, box-shadow 0.2s;">
          </div>
          <div style="display: flex; align-items: center; gap: 12px;">
            <span class="ellipsis" id="videoTogetherRoomPasswordLabel" style="width: 64px; flex-shrink: 0; font-size: 13px; color: #555; font-weight: 500; display: none;">密码</span>
            <input id="videoTogetherRoomPdIpt" autocomplete="off" placeholder="输入建房密码" style="flex: 1; height: 38px; padding: 0 14px; font-size: 14px; border-radius: 10px; border: 1px solid #e0e0e0; background: #fff; outline: none; display: none; transition: border-color 0.2s, box-shadow 0.2s;">
          </div>
        </div>
      ...
      <div id="voicePannel" class="content" style="display: none; flex-direction: column; gap: 8px; width: 100%; flex: 1; min-height: 0;">
        <div id="videoVolumeCtrl" style="width: 100%;text-align: left;">
          <span style="display: inline-block;width: 100px;margin-left: 20px;">视频音量</span>
        ...
        <div id="callVolumeCtrl" style="width: 100%;text-align: left;">
          <span style="display: inline-block;width: 100px;margin-left: 20px;">通话音量</span>
          <div class="range-slider">
    ...
    <div class="vt-modal-footer">
      ...
      <div id="chatInputRow" style="display: flex; gap: 6px; width: 100%; align-items: center; padding: 0 6px; box-sizing: border-box;">
        <input id="textMessageInput" autocomplete="off" placeholder="文字聊天" style="width: calc(100% - 82px); height: 34px; padding: 0 10px; font-size: 13px; border-radius: 6px; border: 1px solid #d9d9d9; box-sizing: border-box; outline: none;">
