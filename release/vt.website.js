    ...
    <div class="vt-modal-body">
      <div id="mainPannel" class="content" style="display: flex; flex-direction: column; width: 100%; height: 100%; gap: 8px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 4px;">
          ...
          <div style="display: flex; align-items: center; gap: 4px;">
            <span class="ellipsis" id="videoTogetherRoomPasswordLabel" style="width: 60px;">密码</span>
            <input id="videoTogetherRoomPdIpt" autocomplete="off" placeholder="输入建房密码" style="flex: 1;">
          </div>
        </div>
