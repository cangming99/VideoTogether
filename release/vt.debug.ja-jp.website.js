  ...
  <div class="vt-modal-content">
      ...
      <div id="mainPannel" class="content" style="display: flex; flex-direction: column; width: 100%; flex: 1; min-height: 0; gap: 8px;">
        <div id="roomInputContainer" style="display: flex; flex-direction: column; gap: 8px; padding: 10px 0; width: 100%;">
          <div style="display: flex; align-items: center; gap: 8px;">
            <span class="ellipsis" id="videoTogetherRoomNameLabel" style="width: 70px; flex-shrink: 0;">ルーム</span>
            <input id="videoTogetherRoomNameInput" autocomplete="off" placeholder="ルーム名を入力してください" style="flex: 1; height: 36px; padding: 0 12px; font-size: 14px; border-radius: 8px; border: 1px solid #d9d9d9;">
          </div>
          <div style="display: flex; align-items: center; gap: 8px;">
            <span class="ellipsis" id="videoTogetherRoomPasswordLabel" style="width: 70px; flex-shrink: 0; display: none;">パスワード</span>
            <input id="videoTogetherRoomPdIpt" autocomplete="off" placeholder="ホストのパスワードを入力" style="flex: 1; height: 36px; padding: 0 12px; font-size: 14px; border-radius: 8px; border: 1px solid #d9d9d9; display: none;">
          </div>
        </div>
    ...
    <div class="vt-modal-footer">
      ...
      <div id="chatInputRow" style="display: flex; gap: 6px; width: 100%; align-items: center; flex-wrap: nowrap; box-sizing: border-box; min-width: 0;">
        <input id="textMessageInput" autocomplete="off" placeholder="テキストメッセージ" style="flex: 1; min-width: 0; height: 34px; padding: 0 10px; font-size: 13px; border-radius: 6px; border: 1px solid #d9d9d9;">
