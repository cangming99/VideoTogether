  ...
  <div class="vt-modal-content">
    ...
    <div class="vt-modal-footer">
      ...
      <div id="chatInputRow" style="display: flex; gap: 6px; width: 100%; align-items: center; flex-direction: row; flex-wrap: nowrap; box-sizing: border-box;">
        <input id="textMessageInput" autocomplete="off" placeholder="テキストメッセージ" style="flex: 1; min-width: 60px; height: 34px; padding: 0 10px; font-size: 13px; border-radius: 6px; border: 1px solid #d9d9d9;">
